...
morgan.format('combined', ':remote-addr - :remote-user [:date[clf]] ":method :url" :status :res[content-length]')
...
morgan.format('dev', function developmentFormatLine(tokens, req, res) {
  ...
  if (!fn) {
    // compile
    fn = developmentFormatLine[color] = compile(':remote-addr - \x1b[0m:method :url \x1b['
